...
function EventsPage() {
  ...
  return (
    <main className="events-page">
      ...
      {notice ? <div className="event-trip-toast">{notice}</div> : null}
...
const eventsCss = `
.event-trip-toast{position:fixed;right:22px;bottom:98px;z-index:78;background:#064e45;color:#fff;border-radius:16px;padding:14px 18px;box-shadow:0 18px 40px rgba(0,0,0,.18);font-weight:900}.event-actions button.event-trip-btn{border:1px solid #ffcf4a;border-radius:15px;text-decoration:none;color:#063c38;background:#ffc425;padding:12px 14px;font-weight:1000;cursor:pointer}.event-actions button.event-trip-btn.saved{background:#e8fff5;color:#05614f;border-color:#64c8a8}
