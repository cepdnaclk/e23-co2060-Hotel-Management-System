...
function RegisterPropertyPage() {
  ...
  const propertyPasswordStrength =
    checkPasswordStrength(
      form.property_password
    );
  ...
  const validateForm =
    () => {
      ...
      const propertyPasswordError =
        getPasswordError(
          form.property_password
        );

      if (
        propertyPasswordError
      ) {
      ...
      if (
        form.property_password !==
        form.confirm_property_password
      ) {
  ...
  const handleSubmit =
    async (e) => {
      ...
      try {
        ...
        const response =
          await api.post(
            "/partner/properties",
            {
              ...
              registration_payment_status:
                form.registration_payment_status,
        ...
        if (logoFile) {
          await uploadImage(
            `/partner/properties/${propertyId}/upload-logo`,
            logoFile
          );
        }
  ...
  return (
    <div
      className="page property-register-page"
      style={
        styles.pageWrap
      }
    >
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  aria-label="Property colour theme"
                  style={
...
const styles = {
  ...
  headerBadge: {
    ...
    boxShadow:
      "0 12px 32px rgba(21,69,58,0.06)",
  },
  ...
  /* PERFECTLY ALIGNED PASSWORD ROW */
  ...
  themeSelector: {
    ...
    gridTemplateColumns:
      "minmax(210px, 0.8fr) minmax(210px, 0.9fr) minmax(220px, 1.3fr)",
...
/* Keep both password inputs exactly aligned */
...
@media (max-width: 900px) {
  ...
  .property-register-page
  [style*="grid-template-columns: minmax(210px, 0.8fr)"] {
    grid-template-columns: 1fr !important;
  }
}
