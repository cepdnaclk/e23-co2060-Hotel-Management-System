...
function HotelsPage() {
  ...
  const filteredProperties = useMemo(() => {
    return properties.filter((property) => {
      ...
      return searchMatches && cityMatches && typeMatches && priceMatches;
    });
  }, [properties, searchText, cityFilter, propertyTypeFilter, minPrice, maxPrice]);
    ...
    <div className="page">
      ...
      <div style={styles.layout}>
        <aside className="card" style={styles.filterBox}>
          ...
          <label style={styles.filterLabel}>Search Hotel</label>

          <input
            type="text"
            value={searchText}
            onChange={(event) => handleSearchChange(event.target.value)}
            placeholder="Search hotel, city, district..."
