...
const initializeGuideProcessSchema = async () => {
  for (const statement of schemaStatements) {
    await pool.query(statement);
  }
};

const ensureGuideProcessSchema = async () => {
  if (!initializationPromise) {
    initializationPromise = initializeGuideProcessSchema().catch((error) => {
...
module.exports = { ensureGuideProcessSchema };
