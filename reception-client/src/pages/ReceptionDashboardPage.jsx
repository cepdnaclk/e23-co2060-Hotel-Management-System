  ...
  return (
    <main className="reception-app">
      ...
      <aside className="reception-sidebar">
        <Link to="/dashboard" className="reception-brand" aria-label="TripLanka reception home"><span>Trip</span><b>Lanka</b></Link>
